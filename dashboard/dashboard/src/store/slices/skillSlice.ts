...
export const addNewSkill = (data:any) => async (dispatch:AppDispatch) => {
  dispatch(skillSlice.actions.addNewSkillRequest());
  try {
    const response = await axios.post(
      "https://portfolio-13of.onrender.com/api/v1/skill/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id:string, proficiency) => async (dispatch:AppDispatch) => {
  dispatch(skillSlice.actions.updateSkillRequest());
  try {
    const response = await axios.put(
      `https://portfolio-13of.onrender.com/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id:string) => async (dispatch:AppDispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-13of.onrender.com/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
