        ...
        <div className="about__grid">
          ...
          <div className="about__textContainer">
            <Typography variant="body1" className="about__description">
              I am Amandeep Singh. I am a Software Engineer with expertise in C++, MySQL, MongoDB, Node.js, React.js, JavaScript, AWS, Docker, and a strong foundation in data structures and algorithms.
